...
<table border="1" align="center" cellpadding="0" cellspacing="1" class="t_border">
  ...
  <tr class="t_row">
    ...
    <tr class="t_row">
    <td>英文名称</td>
    <td><input name="enName" type="text" id="enName" value="" size="48"></td>
  </tr>
...
<table border="1" align="center" cellpadding="0" cellspacing="1" class="t_border">
  ...
  <tr class="t_row">
    <td>英文名称</td>
    <td><input name="EnName" type="text" id="EnName" size="48"></td>
  </tr>
  <tr class="t_row">
    <td>&nbsp;</td>
...
Sub SaveAdd()
	...
	enName=CheckChar(Trim(Request.Form("enName")),"分类名称",50,"012")
...
Sub SaveMod()
	...
	ClassName=CheckChar(Trim(Request.Form("ClassName")),"分类名称",50,"012")
	EnName=CheckChar(Trim(Request.Form("EnName")),"分类英文名称",50,"012")
