...
<table border="0" align="center"  cellpadding="0" cellspacing="1" style="padding-left:50px;">
  ...
  <tr>
    <td ><strong>操作选项</strong>：&nbsp;&nbsp;<a href="job.asp?Action=Add">发布职位</a>&nbsp;|&nbsp;<a href="job.asp">职位管理 | </a><a href="job.asp?Action=chakan">查看应聘信息</a></td>
  </tr>
 </table>
 <br />
<%
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_border">
  <tr align="center" bgcolor="#339933">
	...
	<td width="15%">招聘人数</td>
	<td width="15%">工作经验</td>
    <td width="16%"><span class="hui12">有效期限</span></td>
    <td width="15%">添加时间</td>
    <td width="15%">操作</td>
  </tr>
<%
...
<table border="0" width="95%" align="center" cellpadding="0" cellspacing="1" >
  ...
  <tr class="t_row">
    <td><span class="hui12">工资待遇：</span></td>
    <td><input name="gongzi" type="text" id="gongzi" size="20" />
      &nbsp;&nbsp; <span class="hui12">有效期限：
      <input name="yriqi" type="text" id="yriqi" size="20" />
      </span></td>
  </tr>
  <tr class="t_row">
    <td>招聘人数:</td>
    <td><input name="renshu" type="text" id="renshu" size="20" value="" /> &nbsp;&nbsp; <span class="hui12">船舶类型：
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_border">
  ...
  <tr class="t_row">
    <td><u>过期时间</u></td>
    <td><input type="text" name="yriqi"  id="yriqi" value="<%=yriqi%>" size="48"/>&nbsp;&nbsp; <span class="hui12">船舶类型：
...
<table border="1" align="center" cellpadding="0" cellspacing="1" class="t_border">
  ...
  <tr>
    <th width="153" scope="row">应聘职位:</th>
